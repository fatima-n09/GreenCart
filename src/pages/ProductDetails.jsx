    ...
    product && (
      <div className="mt-12">
              ...
              {Array(5)
                ...
                .map((_, i) => (
                  <img
                    ...
                    alt="star" className="md:w-4 w-3.5"
                  />
                ))}
        ...
        <div className="flex flex-col items-center mt-20">
            ...
            <button onClick={()=>{navigate('/products'); scroll(0,0)}} className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition ">See More</button>
        </div>
      </div>
    )
  );
